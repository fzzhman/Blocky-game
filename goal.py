...
class PerimeterGoal(Goal):
    ...
    def score(self, board: Block) -> int:
        ...
        Rotating, swapping, and passing costs zero points.
        Painting and combing cost one point each.
        Smashing costs two points.
    ...
    def description(self) -> str:
        ...
        description = "The player must aim to put the most possible units " + \
                      "of a given colour, known as the target colour, on the" +\
                      " outer perimeter of the board. The player's score " + \
                      "is the total number of unit cells of the target" + \
                      " colour that are on the perimeter of the block.\n" + \
                      "There is a premium on corner cells: they count twice " +\
                      "towards the score.\n\nRotating, swapping, and passing" +\
                      " cost 0 points each.\nPainting and combining cost " +\
                      "one point each time they are played. Smashing costs" +\
                      " three points each time it is performed."
        return description
...
class BlobGoal(Goal):
    ...
    def description(self) -> str:
        description = "The player must aim for the largest 'blob' of a " +\
            "given colour, known as the target colour. A blob is a " +\
            "group of connected blocks with the same colour. Two blocks " +\
            "are connected if their sides touch; touching corners doesn't " +\
            "count. The player's score is the number of unit cells in the " +\
            "largest blob of the target colour.\n\nRotating, swapping, and " +\
            "passing cost 0 points each.\nPainting and combining cost " + \
            "one point each time they are played. Smashing costs three points"+\
